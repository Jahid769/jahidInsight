$(window).on("load", function () {
    ...
    /*=========================================================================
        Preloader
    =========================================================================*/
    $("#preloader").delay(350).fadeOut("loader");
...
$(function () {
    ...
    $("#my_current_age").html(intYear - 2002); //Show My Current Age
    $("#this_year").html(intYear); //Show Current Year in The Footer
});

/*=========================================================================
            Scroll to Change Hero Text
  =========================================================================*/
var leftItem = document.getElementById("leftItem"),
    rightItem = document.getElementById("rightItem");
...
window.addEventListener("optimizedScroll", function () {
    leftItem.style.transform = "translate3d(-" + window.pageYOffset + "px,0,0)";
    rightItem.style.transform = "translate3d(" + window.pageYOffset + "px,0,0)";
});
